...
class FMEPackageMetadata:
    ...
    def python_packages(self):
        return [PythonPackageMetadata(item) for item in self.package_content.get('python_packages', [])]
    ...
    def web_filesystems(self):
        return [WebFilesystemMetadata(item) for item in self.package_content.get('web_filesystems', [])]
